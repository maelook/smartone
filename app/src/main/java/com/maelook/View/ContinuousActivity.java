...
* 连续测量activity
* */
public class ContinuousActivity extends Activity implements View.OnClickListener {
    //返回按钮
    ...
    * */
    public void initView(){
        btn_back = (Button) findViewById(R.id.Continuousback);
    ...
    public void Continuousback(View view){
        Intent intent=new Intent(ContinuousActivity.this,FirstActivity.class);
    ...
    public void Measure_Going(View going ){
        ...
        new Handler().postDelayed(new Runnable(){
            ...
            public void run(){
                ...
                ContinuousActivity.this.finish();
                Intent intent = new Intent(ContinuousActivity.this, ContinuousLoadingActivity.class);
                startActivity(intent);
    ...
    * */
    ...
    private void setView() {
        ...
        final AddAndSubView addAndSubView1 = new AddAndSubView(ContinuousActivity.this, 5);
