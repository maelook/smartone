 ...
 * DAO for table "MULTI".
*/
public class multiDao extends AbstractDao<multi, String> {

    public static final String TABLENAME = "MULTI";

    /**
     * Properties of entity multi.<br/>
    ...
    public multiDao(DaoConfig config) {
        super(config);
    }
    
    public multiDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MULTI\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MULTI\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, multi entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, multi entity) {
        stmt.clearBindings();
    ...
    @Override
    public multi readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, multi entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(multi entity, long rowId) {
        return entity.getDate();
    }
    
    @Override
    public String getKey(multi entity) {
        if(entity != null) {
            return entity.getDate();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(multi entity) {
