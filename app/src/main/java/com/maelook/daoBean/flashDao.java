 ...
 * DAO for table "FLASH".
*/
public class flashDao extends AbstractDao<flash, String> {

    public static final String TABLENAME = "FLASH";

    /**
     * Properties of entity flash.<br/>
    ...
    public flashDao(DaoConfig config) {
        super(config);
    }
    
    public flashDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FLASH\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FLASH\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, flash entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, flash entity) {
        stmt.clearBindings();
    ...
    @Override
    public flash readEntity(Cursor cursor, int offset) {
        flash entity = new flash( //
    ...
    @Override
    public void readEntity(Cursor cursor, flash entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(flash entity, long rowId) {
        return entity.getDate();
    }
    
    @Override
    public String getKey(flash entity) {
        if(entity != null) {
            return entity.getDate();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(flash entity) {
